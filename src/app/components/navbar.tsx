...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-center mt-7 rel">
      ...
      {/* Mobile Menu */}
      <div 
  className={`fixed top-0 right-0 h-full w-[70%] text-white shadow-xl transform ${
...
>
  ...
  {/* Menu Items */}
  <ul className="flex flex-col items-end gap-6 p-10 pt-20 w-full">
